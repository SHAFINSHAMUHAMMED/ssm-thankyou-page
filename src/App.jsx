  ...
  return (
    <>
      ...
      <div className="thank-you-top-section">
        ...
        <h1 className="hidden-initially animate__animated animate__fadeInUp">
          Congratulations
        </h1>
      ...
      <div className="thank-you-video-main ">
        ...
        <div className="thank-you-video">
          <h3 className="text-[#0B434B]">
            <span className="text-[#259D4A]">Learners University College</span>{" "}
            is For Dreamers, Achievers, And Pioneers.
          </h3>
        ...
        <div className="map-main">
          ...
          <div className="address-section">
            <div className="address-sub">
              ...
              <div className="address-content">
                ...
                <h6>
                  H01, Ground Floor, South Entrance - Sharjah Book Authority -
                  Al Zahiya, Sharjah, UAE
                </h6>
              </div>
            </div>
            ...
            <div className="address-sub">
              ...
              <div className="address-content">
                <a
                  className="address-content"
                  href="mailto:inquiry@learnersuae.com"
                >
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    width="33"
          ...
          >
            <path
              fill-rule="evenodd"
              clip-rule="evenodd"
              d="M108.84 115.459L141.696 116.449L107.453 75.7913L146.829 40.0817L114.139 36.6637L112.53 5.05941L75.8761 38.2995L44.0007 0.452776L38.1761 31.5574L5.32241 30.5695L39.5659 71.228L0.189351 106.937L32.8815 110.354L34.489 141.96L71.1425 108.72L103.017 146.566L108.84 115.459Z"
              fill="#259D4A"
            />
          </svg>
        </div>
        <p className="text-[#05170F] font-medium text-center">
          Landing Page & Digital Marketing By{" "}
          <a
            href="https://webqmedia.com/"
            target="_blank"
            className="text-[#009B3E] font-bold"
          >
            WebQ Media
          </a>
        </p>
